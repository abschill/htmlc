...
function fileMap(path, splitter, basename, type) {
    return {
        ...
        name: mapPath(splitter, basename, process.platform === 'win32' ? exports.__WIN__ : exports.__BSD__),
        isCached: false,
        renderedChunk: null,
...
function findPartials({ partials = __1.HCL_DEFAULTS.partials, pathRoot = __1.HCL_DEFAULTS.pathRoot, discoverPaths = __1.HCL_DEFAULTS.discoverPaths }) {
...
function findTemplates({ templates = __1.HCL_DEFAULTS.templates, pathRoot = __1.HCL_DEFAULTS.pathRoot, discoverPaths = __1.HCL_DEFAULTS.discoverPaths }) {
