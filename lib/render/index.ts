...
const genRenderMap = ( _content: string ): 
 ...
 */
const render = ( declaredPartials: hclFS.FileInputMeta[], rawFile: hclFS.fileUTF8, insertMap: hclInternal._insertMap, debug?: boolean ): 
Runtime.template => {
