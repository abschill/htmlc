...
export declare const matchLoop: (target: string) => string | any | never[];
...
export declare const matchKey: (target: string) => hclInternal._match;
...
export declare const matchPartial: (target: string) => hclInternal._match;
