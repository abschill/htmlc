...
class Loader {
    constructor(_a) {
        ...
        var opts = __rest(_a, []);
        this._config = {
            pathRoot: (_b = opts.pathRoot) !== null && _b !== void 0 ? _b : config_1.default.rootDefault,
            templates: (_c = opts.templates) !== null && _c !== void 0 ? _c : config_1.default.templateDefault,
            partials: (_d = opts.partials) !== null && _d !== void 0 ? _d : config_1.default.partialDefault
        };
